...
PIPELINE_NAME = EXPERIMENT_NAME = "rprclnc-perf-monitor"
...
def main():
    ...
    chiStep = PythonScriptStep(
        name="prediction_distribution_chi",
        script_name=e.prediction_monitor_script_path, 
    ...
    published_pipeline = monitor_pipeline.publish(
        name=PIPELINE_NAME,
        description="Model performance monitor pipeline",
        version=e.build_id,
    )
